...
# Create a new driver
create_driver enet_engine_driver

# Associate it with some hardware known as "enet_dma"
set_sw_property hw_class_name enet_dma
...
set_sw_property min_compatible_hw_version 3.0
...
# C/C++ source files
#add_sw_property c_source src/enet_engine.c

#add_sw_property include_source inc/enet_engine.h
